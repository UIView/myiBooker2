...
{
    UIPageViewController *pageViewController = _style == TDYReaderTransitionStylePageCur ? [[UIPageViewController alloc]init] : [[UIPageViewController alloc]initWithTransitionStyle:UIPageViewControllerTransitionStyleScroll navigationOrientation:UIPageViewControllerNavigationOrientationHorizontal options:nil];
...
{
    if (_style == TDYReaderTransitionStylePageCur) {
        _curPage = page;
    }
